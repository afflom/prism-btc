...
//! The ψ-pipeline's resolver chain produces the 32-byte SHA-256d
//! digest κ-label (architecture §6, wiki ADR-048/049); the helpers
//! here serialize headers, derive the coinbase merkle root, and
//! compute SHA-256d digests at the host boundary (architecture §7).
//!
